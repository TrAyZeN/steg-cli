...
public class Steganography {
    ...
    private static void printHelp() {
        System.out.println("Usage: steg [command] [arguments]\n"
                         ...
                         + "-c, --cipher <method> <parameters> Cipher to apply to the message. Use 'steg -h cipher' to get more informations on available cipher.\n"
                         + "\n"
                         + "Decoding mandatory arguments:\n"
                         + "-i, --input <path>                 The path of the input image.\n"
                         + "Encoding optional arguments:\n"
                         + "-c, --cipher <method> <parameters> Decipher the message. Use 'steg -h cipher' to get more informations on available cipher.\n"
                         + "\n"
                         + "Other options:\n"
